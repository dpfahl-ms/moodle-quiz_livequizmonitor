...
$string['filter:filterslabel'] = 'Filter';
$string['filter:groupoverride'] = 'Mit Gruppen-Überschreibung';
$string['filter:groupoverrideflag'] = 'Diese/r Teilnehmende/r gehört zu einer Gruppe mit einer Überschreibung (Gruppen-Override)';
$string['filter:namelabel'] = 'Name';
$string['filter:overridesgrouplabel'] = 'Überschreibungen';
...
$string['filter:useroverride'] = 'Individuelle Überschreibung';
$string['filter:useroverrideflag'] = 'Für diese/n Teilnehmende/n gilt eine individuelle Verlängerung (User Override)';
$string['filter:usertimeoverrideflag'] = 'Für diese/n Teilnehmende/n gilt eine zeitbezogene Überschreibung (Öffnungs-/Schlusszeit oder Zeitlimit)';
