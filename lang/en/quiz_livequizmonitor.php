...
$string['filter:groupoverrideflag'] = 'This student belongs to a group with an override (group override)';
...
$string['filter:useroverrideflag'] = 'This student has a quiz extension (user override)';
$string['filter:usertimeoverrideflag'] = 'This student has a time-related override (open/close time or time limit)';
